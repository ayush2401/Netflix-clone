  ...
  return (
    <div className="relative h-[56.25vw]">
      <video
        ...
        src={data?.videoUrl}
      ></video>
      <div className="absolute top-[30%] md:top-2/5 ml-4 md:ml-16">
        <p className="text-white text-xl md:text-5xl h-full w-1/2 lg:text-6xl font-bold drop-shadow-xl">{data?.title}</p>
        <p className="text-white text-[8px] md:text-lg mt-3 md:mt-8 w-[90%] md:w-4/5 lg:w-1/2 drop-shadow-xl">{data?.description}</p>
